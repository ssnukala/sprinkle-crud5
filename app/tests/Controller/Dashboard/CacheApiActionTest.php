...
class CacheApiActionTest extends CRUD5TestCase
{
    use RefreshDatabase;
    use WithTestUser;
    ...
    public function testPageForGuestUser(): void
    {
        ...
        $request = $this->createJsonRequest('POST', '/api/dashboard/clear-cache');
        ...
        $this->assertSame('/account/sign-in?redirect=%2Fapi%2Fdashboard%2Fclear-cache', $response->getHeaderLine('Location'));
    }
